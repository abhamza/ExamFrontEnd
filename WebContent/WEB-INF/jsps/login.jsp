...
<div style="position:absolute;left:550px;top:75px;color:white;font-family: arial; ">
Don`t have an account, click here to <a href='${pageContext.request.contextPath}/register' style="color:blue;font-family: ubuntu; " >Register</a>
<br/>
<h3 align="center">${errorMessage}</h3>
 ...
 <div class="wrapper">
  <form class="login" action="checkLogin" method="post">
    ...
    <input name="mail" type="text" placeholder="Username" autofocus/>
